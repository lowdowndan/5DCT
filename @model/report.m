...
ins = ['\includegraphics[width=0.75\textwidth]{' fullfile(aModel.folder,'report', 'errorHist.png') '}'];
lines = cat(1,lines,ins);
...
lines = cat(1,lines,ins);
ins = ['\includegraphics[width=0.75\textwidth]{' fullfile(aModel.folder,'report', 'corMip.png') '}'];
lines = cat(1,lines,ins);
...
ins = ['\includegraphics[width=0.75\textwidth]{' fullfile(aModel.folder,'report', 'sagMip.png') '}'];
lines = cat(1,lines,ins);
